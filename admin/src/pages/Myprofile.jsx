...
const Myprofile = () => {
  ...
  if (!adminData) return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#f3b41d] to-[#1e0750]">
      <motion.div
        animate={{ rotate: 360 }}
  ...
  return (
    <motion.div
      ...
      className="min-h-screen bg-gradient-to-br from-[#def31d] via-[#f31d85] to-[#f3391d] px-4 py-10"
    >
      {/* Floating background elements */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-1/4 left-1/4 w-32 h-32 rounded-full bg-pink-500/10 blur-3xl"></div>
        <div className="absolute bottom-1/3 right-1/3 w-40 h-40 rounded-full bg-orange-500/10 blur-3xl"></div>
        <div className="absolute top-1/3 right-1/4 w-28 h-28 rounded-full bg-red-500/10 blur-3xl"></div>
      </div>
      ...
      <div className="max-w-4xl mx-auto">
        <motion.h1 
          ...
          className="text-4xl md:text-5xl font-bold text-center py-8 text-transparent bg-clip-text bg-gradient-to-r from-[#411df3] to-[#f31d88]"
        >
        User Profile
        </motion.h1>
        ...
        <motion.div
          ...
          transition={{ duration: 0.5 }}
          className="bg-gradient-r from-[#f3f21d] via-[#1d71f3] to-[#f31dec] backdrop-sm border border-white rounded-2xl shadow-2xl p-6 mb-10 overflow-hidden"
        >
          <div className="flex flex-col md:flex-row gap-8 items-start md:items-center justify-between">
            ...
            >
              <div className="relative group">
                {preview && (
                  <motion.img
                    ...
                    src={preview}
                    alt="Profile"
                    className="w-28 h-28 rounded-full border-4 border-indigo-500/40 object-cover shadow-lg group-hover:border-white transition-all duration-300"
                  />
                )}
              ...
              <label
                ...
                className="cursor-pointer bg-gradient-to-r from-[#5af31d] to-[#f31d81] hover:from-indigo-600 hover:to-purple-700 text-white px-6 py-2 rounded-lg inline-block text-center shadow-lg transition-all duration-300 hover:shadow-xl"
              >
                Choose Image
              </label>
            ...
            {!editing ? (
              ...
              >
                <div className="space-y-2">
                  ...
                  <p className="text-lg text-gray-300">
                    ...
                    <span className="italic text-white">Email:</span> 
                    <span className="ml-2 text-white">{adminData.email}</span>
                  </p>
                  <p className="text-md text-gray-300">
                    <span className="text-indigo-300 mr-2">📈</span> 
                    <span className="italic text-white">Submissions:</span> 
                ...
                <motion.button
                  ...
                  className="bg-gradient-to-r from-[#f3b71d] to-[#41f31d] hover:from-blue-600 hover:to-indigo-700 text-white px-6 py-2.5 rounded-lg shadow-lg transition-all duration-300 flex items-center"
                >
              ...
              >
                <div>
                  <label className="block text-sm italic font-medium mb-2 text-indigo-300">Name</label>
                  <input
                    name="username"
                    value={form.username}
        ...
        >
          <h2 className="text-2xl md:text-3xl font-bold italic text-transparent bg-clip-text bg-gradient-to-r from-[#1df358] to-[#f3e31d]">
            📝 My Submissions
          </h2>
          <motion.div 
            whileHover={{ scale: 1.005 }}
            className="bg-gradient-r from-[#f31def] via-[#41f31d] to-[#1d54f3] backdrop-blur-sm border border-white/10 rounded-xl shadow-lg p-6 space-y-4 transition-all duration-300"
          >
