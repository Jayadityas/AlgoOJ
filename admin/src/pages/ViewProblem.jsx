...
const ViewProblem = () => {
  ...
  return (
    <div className="min-h-screen bg-[#07034d] p-30">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2 mt-2">
                {problem.tags.map((tag, idx) => (
                  <span key={idx} className="bg-indigo-100 dark:bg-indigo-600 text-indigo-800 dark:text-white px-3 py-1 rounded-full text-sm">
                    {tag}
                  </span>
                ))}
              </div>
