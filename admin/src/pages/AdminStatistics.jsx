...
const AdminStatistics = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-[#1d27f3] via-[#f31dd6] to-[#e9f31d] py-25 px-4 sm:py-25 sm:px-6 lg:py-25 lg:px-20">
      {/* Header */}
      <motion.div 
      ...
      >
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
          <div className="mb-4 lg:mb-0">
            <h1 className="text-2xl italic sm:text-3xl font-bold text-[#f0f31d] mb-2">Admin Statistics</h1>
            <p className="text-white text-sm sm:text-base">Complete analysis of problem management</p>
          </div>
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center space-y-2 sm:space-y-0 sm:space-x-3">
            <motion.button
              ...
              className="flex items-center justify-center px-4 py-2 bg-gradient-to-r from-[#34bd30]  to-[#0e3cf7] text-white rounded-lg shadow-md hover:shadow-lg transition-all text-sm sm:text-base"
            >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              onClick={exportData}
              className="flex items-center justify-center px-4 py-2 bg-gradient-to-r from-[#f31d2d]  to-[#d91df3] text-white rounded-lg shadow-md hover:shadow-lg transition-all text-sm sm:text-base"
            >
      ...
      {/* KPI Cards */}
      <div className="grid grid-cols-1 italic  sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-6 sm:mb-8">
        {[
          {
            title: "Total Users",
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6 sm:gap-8 mb-6 sm:mb-8">
        ...
        <motion.div
          ...
          className="bg-white rounded-xl shadow-sm p-4 sm:p-6 border border-gray-100 hover:shadow-md transition-shadow"
        >
          <div className="flex italic flex-col sm:flex-row sm:items-center sm:justify-between mb-4">
        ...
        <motion.div
          ...
          className="bg-white rounded-xl shadow-sm p-4 sm:p-6 border border-gray-100 hover:shadow-md transition-shadow"
        >
          <div className="flex flex-col italic sm:flex-row sm:items-center sm:justify-between mb-4">
      ...
      <motion.div
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        className="bg-white/70 rounded-xl italic shadow-sm border border-gray-100 overflow-hidden"
      >
        <div 
          className="p-4 sm:p-6 border-b italic border-gray-200 cursor-pointer flex justify-between items-center"
        ...
        >
          <div className="space-y-4">
            ...
            <div className="relative">
              <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 text-white-400 w-4 h-4 sm:w-5 sm:h-5" />
              <input
                type="text"
                placeholder="Search problems by title..."
                value={filters.searchTerm}
                onChange={(e) => setFilters(prev => ({ ...prev, searchTerm: e.target.value }))}
                className="w-full pl-8 sm:pl-10 pr-4 py-2 border border-white rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all text-sm sm:text-base"
              />
            </div>
                    ...
                    <motion.button
                      ...
                      className={`px-3 sm:px-4 py-1 sm:py-2 rounded-lg text-xs sm:text-sm font-medium transition-all flex items-center ${
                        filters.difficulty.includes(difficulty)
                          ? difficulty === 'Easy' ? 'bg-green-20 text-green-800 border border-green-300 shadow-inner'
